...
class UniqueKeyLoader(Loader):
    """
    Verify that mappings do not contain duplicate keys
    from https://gist.github.com/pypt/94d747fe5180851196eb user: https://gist.github.com/ngaya-ll
    """
...
def read_yaml(hndl, normalize=False):
    ...
    cfg = yaml.load(hndl, UniqueKeyLoader)
